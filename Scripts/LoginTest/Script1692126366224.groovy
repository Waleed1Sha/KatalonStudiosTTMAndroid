...
//RunConfiguration.setMobileDriverPreferencesProperty('appWaitActivity', 'com.photogauge.masterapp.ui.presenter.login.LoginActivity' // Replace with your app's main activity
//    )
...
Mobile.tap(findTestObject('Object Repository/obj rep 2/android.widget.Button - Capture'), 0)

Mobile.tap(findTestObject('Object Repository/obj rep 2/android.widget.ImageView (2)'), 0)
